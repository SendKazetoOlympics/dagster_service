...
def upload_frames_to_label_studio(minio: MinioResource, label_studio: LabelStudioResource, frame_id: str):
    url = minio.get_object_presigned_url(frame_id)
    label_studio.create_task(project_id="1", url=url, file_name=frame_id)
